// Centralized bilingual content.
// Add new locales by extending the `Lang` union and providing the same shape.
...
export const BRAND = {
  ...
  tagline: {
    fr: "Anti-nuisibles • Hygiène",
    en: "Pest control • Hygiene",
  },
...
export const SERVICES = [
  ...
  },
  {
    ...
    audience: {
      fr: "Maisons, hôtels, guest houses",
      en: "Homes, hotels, guest houses",
    },
  },
  {
    id: "termites",
  ...
  },
  {
    ...
    audience: {
      fr: "Bureaux, restaurants, écoles",
      en: "Offices, restaurants, schools",
    },
  },
  {
    id: "monthly",
    ...
    title: {
      fr: "Contrats mensuels anti-nuisibles",
      en: "Monthly pest control contracts",
    },
    short: {
...
export const CUSTOMERS = [
  ...
  },
  {
    ...
    title: {
      fr: "Écoles, cliniques & institutions",
      en: "Schools, clinics & institutions",
    },
    short: {
...
export const PRICING = {
  homes: {
    fr: {
      ...
      tiers: [
        {
          name: "Petit traitement",
          price: "dès 25$",
          desc: "Studio, petite maison, cafards ou insectes simples.",
          highlight: false,
        },
        {
          name: "Maison Standard",
          price: "dès 45$",
          desc: "Maison/parcelle, cafards, fourmis, moustiques.",
          highlight: true,
        },
        {
          name: "Maison Plus",
          price: "dès 75$",
          desc: "Grande maison, extérieur, plusieurs pièces, problème avancé.",
          highlight: false,
        },
        {
          name: "Punaises de lit / termites",
          price: "Devis",
          desc: "Devis après inspection.",
          highlight: false,
        },
      ],
    },
      ...
      tiers: [
        {
          ...
          price: "from $25",
          desc: "Studio, small home, basic cockroach or insect issue.",
          highlight: false,
        },
        {
          name: "Standard home",
          price: "from $45",
          desc: "Home/compound, cockroaches, ants, mosquitoes.",
          highlight: true,
        },
        {
          name: "Large home",
          price: "from $75",
          desc: "Large home, exterior, multiple rooms, advanced issue.",
          highlight: false,
        },
        {
          name: "Bed bugs / termites",
          price: "Quote",
          desc: "Quote after inspection.",
          highlight: false,
        },
      ],
    },
      ...
      tiers: [
        {
          ...
          price: "dès 60$",
          desc: "Inspection + traitement + recommandations.",
          highlight: false,
        },
        {
          name: "Business Protect Mensuel",
          price: "dès 50$/mois",
          desc: "Visite mensuelle, suivi, prévention, rapport.",
          highlight: true,
        },
        {
          name: "Hôtel / dépôt / école",
          price: "Sur devis",
          desc: "Plan adapté selon taille et fréquence.",
          highlight: false,
        },
        {
          name: "Premium Mensuel",
          price: "dès 150$/mois",
          desc: "2 à 4 visites/mois, suivi prioritaire, rapport, plan de prévention.",
          highlight: false,
        },
      ],
    },
      ...
      tiers: [
        {
          name: "Restaurant Start",
          price: "from $60",
          desc: "Inspection + treatment + recommendations.",
          highlight: false,
        },
        {
          name: "Monthly Business Protect",
          price: "from $50/mo",
          desc: "Monthly visit, follow-up, prevention, report.",
          highlight: true,
        },
        {
          name: "Hotel / warehouse / school",
          price: "Custom quote",
          desc: "Plan adapted to size and frequency.",
          highlight: false,
        },
        {
          name: "Premium Monthly",
          price: "from $150/mo",
          desc: "2–4 visits/month, priority follow-up, report, prevention plan.",
          highlight: false,
        },
      ],
    },
...
export const STEPS = [
  {
    fr: {
      ...
      desc: "Envoyez un message WhatsApp, appelez ou remplissez le formulaire.",
    },
    en: {
      title: "Contact us",
      desc: "Send a WhatsApp message, call or fill the form.",
    },
  },
  {
    fr: {
      title: "Inspection ou analyse rapide",
      desc: "Nous évaluons le type de nuisible, la taille du lieu et le niveau d'infestation.",
    },
    en: {
      title: "Inspection or quick analysis",
      desc: "We assess the pest type, the size of the place and the level of infestation.",
    },
  },
  {
    fr: {
      title: "Prix clair avant intervention",
      desc: "Vous recevez un prix ou un devis avant le début du traitement.",
    },
    en: {
      title: "Clear pricing before treatment",
      desc: "You receive a price or quote before any treatment begins.",
    },
  },
  {
    fr: {
      title: "Intervention professionnelle",
      desc: "Traitement adapté, conseils de prévention et travail propre.",
    },
    en: {
      title: "Professional treatment",
      desc: "Adapted treatment, prevention advice and clean work.",
    },
  },
  {
    fr: {
      title: "Suivi après traitement",
      desc: "Suivi inclus selon le type d'intervention. Contrat mensuel possible.",
    },
    en: {
      title: "Post-treatment follow-up",
      desc: "Follow-up included depending on the service. Monthly contracts available.",
    },
  },
];
...
export const FAQS: {
  ...
  fr: [
    {
      q: "Combien coûte une intervention anti-nuisibles à Kinshasa ?",
      a: "Les prix démarrent à 25$ pour un petit traitement et varient selon la taille du lieu, le type de nuisible et le niveau d'infestation. Le prix final est confirmé après inspection ou photos sur WhatsApp.",
    },
    {
      q: "Est-ce que l'inspection est gratuite ?",
      a: "Oui, l'inspection initiale est gratuite à Kinshasa pour évaluer le problème et vous donner un prix clair.",
    },
    {
      q: "Intervenez-vous pour les restaurants et hôtels ?",
      a: "Oui. Nous travaillons régulièrement avec des restaurants, bars, hôtels et guest houses, avec un service discret et des contrats mensuels disponibles.",
    },
    {
      q: "Proposez-vous des contrats mensuels ?",
      a: "Oui, à partir de 50$/mois pour les entreprises, avec visites planifiées, suivi et rapport.",
    },
    {
      q: "Est-ce que le traitement est dangereux pour les enfants ou animaux ?",
      a: "Les produits sont appliqués avec méthode et précaution. Nous indiquons toujours le temps d'attente avant de réoccuper la zone et les précautions à prendre.",
    },
    {
      q: "Combien de temps dure une intervention ?",
      a: "Une intervention standard dure entre 45 minutes et 2 heures selon la surface et le type de nuisible.",
    },
    {
      q: "Que faire avant l'arrivée du technicien ?",
      a: "Nous envoyons les consignes de préparation par WhatsApp (ranger la nourriture, dégager les zones à traiter, etc.) selon le type de traitement.",
    },
    {
      q: "Est-ce que vous traitez les punaises de lit ?",
      a: "Oui, avec inspection, traitement ciblé, conseils de préparation et suivi pour s'assurer de l'élimination.",
    },
    {
      q: "Est-ce que vous faites la dératisation des dépôts ?",
      a: "Oui, nous installons des plans de dératisation pour dépôts, magasins et entrepôts, avec postes d'appâtage et contrôle régulier.",
    },
    {
      q: "Dans quelles communes de Kinshasa intervenez-vous ?",
      a: "Nous couvrons toutes les communes de Kinshasa : Gombe, Ngaliema, Limete, Bandalungwa, Kintambo, Lemba, Matete, Kalamu, Barumbu, Mont Ngafula, Masina, N'Djili, Kimbanseke et plus.",
    },
  ],
  en: [
    {
      q: "How much does pest control cost in Kinshasa?",
      a: "Prices start at $25 for a small treatment and vary by location size, pest type and infestation level. Final pricing is confirmed after inspection or photos on WhatsApp.",
    },
    {
      q: "Is the inspection free?",
      a: "Yes, initial inspection is free in Kinshasa to assess the issue and give you clear pricing.",
    },
    {
      q: "Do you serve restaurants and hotels?",
      a: "Yes. We regularly work with restaurants, bars, hotels and guest houses, with discreet service and monthly contracts available.",
    },
    {
      q: "Do you offer monthly contracts?",
      a: "Yes, starting from $50/month for businesses with scheduled visits, follow-up and reports.",
    },
    {
      q: "Is the treatment safe for children or pets?",
      a: "Products are applied with method and care. We always indicate the wait time before reoccupying the area and precautions to take.",
    },
    {
      q: "How long does a treatment take?",
      a: "A standard treatment takes between 45 minutes and 2 hours depending on the surface and pest type.",
    },
    {
      q: "What should I do before the technician arrives?",
      a: "We send preparation instructions by WhatsApp (store food, clear the areas to be treated, etc.) based on the treatment type.",
    },
    {
      q: "Do you treat bed bugs?",
      a: "Yes, with inspection, targeted treatment, preparation advice and follow-up to ensure elimination.",
    },
    {
      q: "Do you provide rodent control for warehouses?",
      a: "Yes, we set up rodent control plans for warehouses, stores and depots with bait stations and regular control.",
    },
    {
      q: "Which areas of Kinshasa do you cover?",
      a: "We cover every commune of Kinshasa: Gombe, Ngaliema, Limete, Bandalungwa, Kintambo, Lemba, Matete, Kalamu, Barumbu, Mont Ngafula, Masina, N'Djili, Kimbanseke and more.",
    },
  ],
};
...
export const T = {
  fr: {
    ...
    hero: {
      eyebrow: "Pestivo Services Kinshasa · Anti-nuisibles professionnel",
      headline: "Dératisation & désinsectisation à Kinshasa",
      sub: "Cafards, rats, moustiques, punaises, fourmis ou termites ? Pestivo Services intervient pour les maisons, restaurants, hôtels, bureaux et dépôts avec inspection gratuite, prix clair et suivi après traitement.",
      bullets: [
        "Inspection gratuite à Kinshasa",
        "Intervention pour maisons et entreprises",
        "Prix clair avant traitement",
        "Contrats mensuels disponibles",
      ],
    },
    sections: {
      problemTitle:
        "Traiter les nuisibles, protéger l'hygiène et prévenir leur retour",
      problemBody:
        "Les cafards, rats, moustiques, fourmis, punaises et termites apparaissent souvent là où il y a nourriture, humidité, déchets, ouvertures ou surfaces mal entretenues. Pestivo Services traite le problème visible et vous aide à réduire les risques de retour grâce à une méthode professionnelle et préventive.",
      ...
      pricingSub:
        "Le prix final est confirmé après inspection ou analyse des photos/vidéos envoyées sur WhatsApp.",
      ...
      finalCtaTitle: "Besoin d'une intervention ?",
      finalCtaBody:
        "Envoyez votre demande et recevez une inspection gratuite avec un prix clair avant toute intervention.",
    ...
    form: {
      ...
      thanks:
        "Merci. Votre demande a été reçue. Nous vous contacterons rapidement pour confirmer l'inspection ou le devis.",
      customerOptions: [
        "Maison",
        "Restaurant",
        "Hôtel",
  ...
  en: {
    ...
    hero: {
      eyebrow: "Pestivo Services Kinshasa · Professional pest control",
      headline: "Pest control & disinfection in Kinshasa",
      sub: "Cockroaches, rats, mosquitoes, bed bugs, ants or termites? Pestivo Services helps homes, restaurants, hotels, offices and warehouses with free inspection, clear pricing and follow-up after treatment.",
      bullets: [
    ...
    sections: {
      problemTitle:
        "Treat pests, protect hygiene and help prevent their return",
      problemBody:
        "Cockroaches, rats, mosquitoes, ants, bed bugs and termites often appear where there is food, moisture, waste, openings or poorly maintained surfaces. Pestivo Services treats the visible problem and helps reduce the risk of recurrence through a professional and preventive method.",
      ...
      pricingSub:
        "Final pricing is confirmed after inspection or after reviewing photos/videos sent on WhatsApp.",
      ...
      finalCtaTitle: "Need a treatment?",
      finalCtaBody: "Send your request and get a free inspection with clear pricing before any treatment.",
    ...
    form: {
      ...
      submit: "Send request",
      thanks:
        "Thank you. Your request has been received. We will contact you shortly to confirm your inspection or quote.",
      customerOptions: [
        "Home",
        "Restaurant",
        "Hotel",
...
export const BLOG_POSTS = [
  {
    slug: {
      fr: "signes-cafards-maison",
      en: "signs-of-cockroaches-at-home",
    },
    title: {
  ...
  {
    slug: {
      fr: "signes-rats-restaurant",
      en: "signs-of-rats-restaurant",
    },
    title: {
  ...
  {
    slug: {
      fr: "moustiques-kinshasa",
      en: "reduce-mosquitoes-kinshasa",
    },
    title: {
  ...
  {
    slug: {
      fr: "preparer-desinsectisation",
      en: "prepare-pest-treatment",
    },
    title: {
  ...
  {
    slug: {
      fr: "contrat-mensuel-restaurant",
      en: "monthly-restaurant-contract",
    },
    title: {
  ...
  {
    slug: {
      fr: "punaises-de-lit-preparation",
      en: "bed-bugs-before-treatment",
    },
    title: {
